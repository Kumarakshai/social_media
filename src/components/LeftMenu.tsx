...
const LeftMenu = ({ type }: { type: "home" | "profile" }) => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="p-4 bg-white rounded-2xl shadow-md text-sm text-gra-500 flex flex-col gap-2">
        <Link
          href="/"
          className="flex items-center gap-4 p-2 rounded-2xl hover:bg-slate-100"
        >
